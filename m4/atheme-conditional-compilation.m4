...
AC_DEFUN([ATHEME_COND_LEGACY_PWCRYPTO_ENABLE], [
	...
	LEGACY_PWCRYPTO_COND_C="base64.c ircservices.c"
...
AC_DEFUN([ATHEME_COND_PBKDF2_BENCHMARK_ENABLE], [

	PBKDF2_BENCHMARK_COND_D="pbkdf2-benchmark"
	AC_SUBST([PBKDF2_BENCHMARK_COND_D])
])
