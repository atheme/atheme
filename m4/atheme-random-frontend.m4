AC_DEFUN([ATHEME_DECIDE_RANDOM_FRONTEND], [
	...
	AS_IF([test "x${RANDOM_FRONTEND}x${LIBSODIUMRNG}" = "xInternalxYes"], [
	...
	AS_IF([test "x${RANDOM_FRONTEND}x${LIBMBEDCRYPTORNG}" = "xInternalxYes"], [
	...
	AS_IF([test "x${RANDOM_FRONTEND}" = "xInternal"], [
