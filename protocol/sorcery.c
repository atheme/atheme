 ...
 *
 * $Id: sorcery.c 4871 2006-02-28 01:10:05Z jilles $
 */

#include "atheme.h"
#include "protocol/sorcery.h"

DECLARE_MODULE_V1("protocol/sorcery", TRUE, _modinit, NULL, "$Id: sorcery.c 4871 2006-02-28 01:10:05Z jilles $", "Atheme Development Group <http://www.atheme.org>");
