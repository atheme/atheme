 ...
 *
 * $Id: sorcery.c 3767 2005-11-10 01:28:36Z jilles $
 */

#include "atheme.h"
#include "protocol/sorcery.h"

DECLARE_MODULE_V1("protocol/sorcery", TRUE, _modinit, NULL, "$Id: sorcery.c 3767 2005-11-10 01:28:36Z jilles $", "Atheme Development Group <http://www.atheme.org>");
