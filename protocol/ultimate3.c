 ...
 *
 * $Id: ultimate3.c 4481 2006-01-04 15:24:07Z jilles $
 */

#include "atheme.h"
#include "protocol/ultimate3.h"

DECLARE_MODULE_V1("protocol/ultimate3", TRUE, _modinit, NULL, "$Id: ultimate3.c 4481 2006-01-04 15:24:07Z jilles $", "Atheme Development Group <http://www.atheme.org>");
