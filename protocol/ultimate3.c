 ...
 *
 * $Id: ultimate3.c 4571 2006-01-19 13:37:54Z jilles $
 */

#include "atheme.h"
#include "protocol/ultimate3.h"

DECLARE_MODULE_V1("protocol/ultimate3", TRUE, _modinit, NULL, "$Id: ultimate3.c 4571 2006-01-19 13:37:54Z jilles $", "Atheme Development Group <http://www.atheme.org>");
