 ...
 *
 * $Id: dreamforge.c 3035 2005-10-20 00:00:13Z jilles $
 */

#include "atheme.h"
#include "protocol/dreamforge.h"

DECLARE_MODULE_V1("protocol/dreamforge", TRUE, _modinit, NULL, "$Id: dreamforge.c 3035 2005-10-20 00:00:13Z jilles $", "Atheme Development Group <http://www.atheme.org>");
