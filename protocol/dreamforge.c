 ...
 *
 * $Id: dreamforge.c 6309 2006-09-06 16:07:30Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/dreamforge", TRUE, _modinit, NULL, "$Id: dreamforge.c 6309 2006-09-06 16:07:30Z jilles $", "Atheme Development Group <http://www.atheme.org>");
