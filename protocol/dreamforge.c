 ...
 *
 * $Id: dreamforge.c 4585 2006-01-19 16:25:49Z jilles $
 */

#include "atheme.h"
#include "protocol/dreamforge.h"

DECLARE_MODULE_V1("protocol/dreamforge", TRUE, _modinit, NULL, "$Id: dreamforge.c 4585 2006-01-19 16:25:49Z jilles $", "Atheme Development Group <http://www.atheme.org>");
