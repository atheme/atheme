 ...
 *
 * $Id: dreamforge.c 4481 2006-01-04 15:24:07Z jilles $
 */

#include "atheme.h"
#include "protocol/dreamforge.h"

DECLARE_MODULE_V1("protocol/dreamforge", TRUE, _modinit, NULL, "$Id: dreamforge.c 4481 2006-01-04 15:24:07Z jilles $", "Atheme Development Group <http://www.atheme.org>");
