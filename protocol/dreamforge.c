 ...
 *
 * $Id: dreamforge.c 6395 2006-09-14 15:47:01Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/dreamforge", TRUE, _modinit, NULL, "$Id: dreamforge.c 6395 2006-09-14 15:47:01Z jilles $", "Atheme Development Group <http://www.atheme.org>");
