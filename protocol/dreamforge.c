 ...
 *
 * $Id: dreamforge.c 3835 2005-11-11 11:31:28Z jilles $
 */

#include "atheme.h"
#include "protocol/dreamforge.h"

DECLARE_MODULE_V1("protocol/dreamforge", TRUE, _modinit, NULL, "$Id: dreamforge.c 3835 2005-11-11 11:31:28Z jilles $", "Atheme Development Group <http://www.atheme.org>");
