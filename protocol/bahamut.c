 ...
 *
 * $Id: bahamut.c 3565 2005-11-06 14:17:51Z jilles $
 */

#include "atheme.h"
#include "protocol/bahamut.h"

DECLARE_MODULE_V1("protocol/bahamut", TRUE, _modinit, NULL, "$Id: bahamut.c 3565 2005-11-06 14:17:51Z jilles $", "Atheme Development Group <http://www.atheme.org>");
