 ...
 *
 * $Id: bahamut.c 5370 2006-06-11 23:02:20Z jilles $
 */

#include "atheme.h"
#include "protocol/bahamut.h"

DECLARE_MODULE_V1("protocol/bahamut", TRUE, _modinit, NULL, "$Id: bahamut.c 5370 2006-06-11 23:02:20Z jilles $", "Atheme Development Group <http://www.atheme.org>");
