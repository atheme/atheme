 ...
 *
 * $Id: bahamut.c 4581 2006-01-19 15:18:35Z jilles $
 */

#include "atheme.h"
#include "protocol/bahamut.h"

DECLARE_MODULE_V1("protocol/bahamut", TRUE, _modinit, NULL, "$Id: bahamut.c 4581 2006-01-19 15:18:35Z jilles $", "Atheme Development Group <http://www.atheme.org>");
