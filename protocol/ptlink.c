 ...
 *
 * $Id: ptlink.c 4607 2006-01-19 23:05:17Z jilles $
 */

#include "atheme.h"
#include "protocol/ptlink.h"

DECLARE_MODULE_V1("protocol/ptlink", TRUE, _modinit, NULL, "$Id: ptlink.c 4607 2006-01-19 23:05:17Z jilles $", "Atheme Development Group <http://www.atheme.org>");
