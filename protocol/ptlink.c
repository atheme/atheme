 ...
 *
 * $Id: ptlink.c 3173 2005-10-23 22:49:41Z jilles $
 */

#include "atheme.h"
#include "protocol/ptlink.h"

DECLARE_MODULE_V1("protocol/ptlink", TRUE, _modinit, NULL, "$Id: ptlink.c 3173 2005-10-23 22:49:41Z jilles $", "Atheme Development Group <http://www.atheme.org>");
