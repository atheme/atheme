 ...
 *
 * $Id: ptlink.c 4121 2005-12-17 04:44:46Z w00t $
 */

#include "atheme.h"
#include "protocol/ptlink.h"

DECLARE_MODULE_V1("protocol/ptlink", TRUE, _modinit, NULL, "$Id: ptlink.c 4121 2005-12-17 04:44:46Z w00t $", "Atheme Development Group <http://www.atheme.org>");
