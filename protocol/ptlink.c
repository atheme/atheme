 ...
 *
 * $Id: ptlink.c 6291 2006-09-06 02:26:55Z pippijn $
 */
...
DECLARE_MODULE_V1("protocol/ptlink", TRUE, _modinit, NULL, "$Id: ptlink.c 6291 2006-09-06 02:26:55Z pippijn $", "Atheme Development Group <http://www.atheme.org>");
...
static void m_newmask(sourceinfo_t *si, uint8_t parc, char *parv[])
{
	user_t *target;
	char *p;
