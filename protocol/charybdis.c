 ...
 *
 * $Id: charybdis.c 6079 2006-08-16 16:44:39Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/charybdis", TRUE, _modinit, NULL, "$Id: charybdis.c 6079 2006-08-16 16:44:39Z jilles $", "Atheme Development Group <http://www.atheme.org>");
