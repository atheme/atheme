 ...
 *
 * $Id: charybdis.c 6401 2006-09-14 16:03:29Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/charybdis", TRUE, _modinit, NULL, "$Id: charybdis.c 6401 2006-09-14 16:03:29Z jilles $", "Atheme Development Group <http://www.atheme.org>");
