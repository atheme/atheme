 ...
 *
 * $Id: asuka.c 6995 2006-10-28 15:04:27Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/asuka", TRUE, _modinit, NULL, "$Id: asuka.c 6995 2006-10-28 15:04:27Z jilles $", "Atheme Development Group <http://www.atheme.org>");
