 ...
 *
 * $Id: undernet.c 4687 2006-01-23 00:21:25Z jilles $
 */

#include "atheme.h"
#include "protocol/undernet.h"

DECLARE_MODULE_V1("protocol/undernet", TRUE, _modinit, NULL, "$Id: undernet.c 4687 2006-01-23 00:21:25Z jilles $", "Atheme Development Group <http://www.atheme.org>");
