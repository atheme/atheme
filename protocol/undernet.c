 ...
 *
 * $Id: undernet.c 5384 2006-06-15 12:43:01Z jilles $
 */

#include "atheme.h"
#include "protocol/undernet.h"

DECLARE_MODULE_V1("protocol/undernet", TRUE, _modinit, NULL, "$Id: undernet.c 5384 2006-06-15 12:43:01Z jilles $", "Atheme Development Group <http://www.atheme.org>");
