 ...
 *
 * $Id: undernet.c 6305 2006-09-06 15:35:33Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/undernet", TRUE, _modinit, NULL, "$Id: undernet.c 6305 2006-09-06 15:35:33Z jilles $", "Atheme Development Group <http://www.atheme.org>");
