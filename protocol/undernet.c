 ...
 *
 * $Id: undernet.c 4589 2006-01-19 17:22:13Z jilles $
 */

#include "atheme.h"
#include "protocol/undernet.h"

DECLARE_MODULE_V1("protocol/undernet", TRUE, _modinit, NULL, "$Id: undernet.c 4589 2006-01-19 17:22:13Z jilles $", "Atheme Development Group <http://www.atheme.org>");
