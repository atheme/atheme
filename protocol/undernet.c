 ...
 *
 * $Id: undernet.c 4619 2006-01-20 00:27:51Z jilles $
 */

#include "atheme.h"
#include "protocol/undernet.h"

DECLARE_MODULE_V1("protocol/undernet", TRUE, _modinit, NULL, "$Id: undernet.c 4619 2006-01-20 00:27:51Z jilles $", "Atheme Development Group <http://www.atheme.org>");
