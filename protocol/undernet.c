 ...
 *
 * $Id: undernet.c 5458 2006-06-20 19:01:32Z jilles $
 */

#include "atheme.h"
#include "protocol/undernet.h"

DECLARE_MODULE_V1("protocol/undernet", TRUE, _modinit, NULL, "$Id: undernet.c 5458 2006-06-20 19:01:32Z jilles $", "Atheme Development Group <http://www.atheme.org>");
