 ...
 *
 * $Id: undernet.c 4605 2006-01-19 22:18:04Z jilles $
 */

#include "atheme.h"
#include "protocol/undernet.h"

DECLARE_MODULE_V1("protocol/undernet", TRUE, _modinit, NULL, "$Id: undernet.c 4605 2006-01-19 22:18:04Z jilles $", "Atheme Development Group <http://www.atheme.org>");
