 ...
 *
 * $Id: undernet.c 4621 2006-01-20 01:44:46Z jilles $
 */

#include "atheme.h"
#include "protocol/undernet.h"

DECLARE_MODULE_V1("protocol/undernet", TRUE, _modinit, NULL, "$Id: undernet.c 4621 2006-01-20 01:44:46Z jilles $", "Atheme Development Group <http://www.atheme.org>");
