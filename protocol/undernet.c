 ...
 *
 * $Id: undernet.c 4627 2006-01-20 11:51:44Z jilles $
 */

#include "atheme.h"
#include "protocol/undernet.h"

DECLARE_MODULE_V1("protocol/undernet", TRUE, _modinit, NULL, "$Id: undernet.c 4627 2006-01-20 11:51:44Z jilles $", "Atheme Development Group <http://www.atheme.org>");
