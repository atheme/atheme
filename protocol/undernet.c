 ...
 *
 * $Id: undernet.c 4607 2006-01-19 23:05:17Z jilles $
 */

#include "atheme.h"
#include "protocol/undernet.h"

DECLARE_MODULE_V1("protocol/undernet", TRUE, _modinit, NULL, "$Id: undernet.c 4607 2006-01-19 23:05:17Z jilles $", "Atheme Development Group <http://www.atheme.org>");
