 ...
 *
 * $Id: plexus.c 3565 2005-11-06 14:17:51Z jilles $
 */

#include "atheme.h"
#include "protocol/plexus.h"

DECLARE_MODULE_V1("protocol/plexus", TRUE, _modinit, NULL, "$Id: plexus.c 3565 2005-11-06 14:17:51Z jilles $", "Atheme Development Group <http://www.atheme.org>");
