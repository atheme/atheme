 ...
 *
 * $Id: monkey.c 3203 2005-10-25 22:22:40Z jilles $
 */

#include "atheme.h"
#include "protocol/monkey.h"

DECLARE_MODULE_V1("protocol/monkey", TRUE, _modinit, NULL, "$Id: monkey.c 3203 2005-10-25 22:22:40Z jilles $", "Atheme Development Group <http://www.atheme.org>");
