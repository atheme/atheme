 ...
 *
 * $Id: monkey.c 5498 2006-06-22 13:30:35Z jilles $
 */

#include "atheme.h"
#include "protocol/monkey.h"

DECLARE_MODULE_V1("protocol/monkey", TRUE, _modinit, NULL, "$Id: monkey.c 5498 2006-06-22 13:30:35Z jilles $", "Atheme Development Group <http://www.atheme.org>");
