 ...
 *
 * $Id: monkey.c 3565 2005-11-06 14:17:51Z jilles $
 */

#include "atheme.h"
#include "protocol/monkey.h"

DECLARE_MODULE_V1("protocol/monkey", TRUE, _modinit, NULL, "$Id: monkey.c 3565 2005-11-06 14:17:51Z jilles $", "Atheme Development Group <http://www.atheme.org>");
