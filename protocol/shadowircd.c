 ...
 *
 * $Id: shadowircd.c 3767 2005-11-10 01:28:36Z jilles $
 */

#include "atheme.h"
#include "protocol/shadowircd.h"

DECLARE_MODULE_V1("protocol/shadowircd", TRUE, _modinit, NULL, "$Id: shadowircd.c 3767 2005-11-10 01:28:36Z jilles $", "Atheme Development Group <http://www.atheme.org>");
