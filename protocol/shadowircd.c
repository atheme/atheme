 ...
 *
 * $Id: shadowircd.c 5456 2006-06-20 16:47:01Z jilles $
 */

#include "atheme.h"
#include "protocol/shadowircd.h"

DECLARE_MODULE_V1("protocol/shadowircd", TRUE, _modinit, NULL, "$Id: shadowircd.c 5456 2006-06-20 16:47:01Z jilles $", "Atheme Development Group <http://www.atheme.org>");
