 ...
 *
 * $Id: shadowircd.c 6079 2006-08-16 16:44:39Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/shadowircd", TRUE, _modinit, NULL, "$Id: shadowircd.c 6079 2006-08-16 16:44:39Z jilles $", "Atheme Development Group <http://www.atheme.org>");
