 ...
 *
 * $Id: shadowircd.c 3835 2005-11-11 11:31:28Z jilles $
 */

#include "atheme.h"
#include "protocol/shadowircd.h"

DECLARE_MODULE_V1("protocol/shadowircd", TRUE, _modinit, NULL, "$Id: shadowircd.c 3835 2005-11-11 11:31:28Z jilles $", "Atheme Development Group <http://www.atheme.org>");
