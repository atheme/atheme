 ...
 *
 * $Id: hyperion.c 4871 2006-02-28 01:10:05Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/hyperion", TRUE, _modinit, NULL, "$Id: hyperion.c 4871 2006-02-28 01:10:05Z jilles $", "Atheme Development Group <http://www.atheme.org>");
