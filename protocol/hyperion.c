 ...
 *
 * $Id: hyperion.c 6071 2006-08-16 14:58:16Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/hyperion", TRUE, _modinit, NULL, "$Id: hyperion.c 6071 2006-08-16 14:58:16Z jilles $", "Atheme Development Group <http://www.atheme.org>");
