...
digest_testsuite_run_pbkdf2_sha1(void)
{
...

	{
		...
		static const uint8_t vector[] = {
			0x16, 0xA5, 0x1F, 0x7F, 0x0E, 0x43, 0xEE, 0xB9,
			0xBD, 0xE0, 0x5D, 0xC3, 0x2E, 0xDA, 0xDA, 0x79,
			0x8D, 0xA5, 0xBA, 0xC1,
		};
...

	{
		...
		static const uint8_t vector[] = {
			0x2D, 0x95, 0xDE, 0xCA, 0xFB, 0x09, 0x8B, 0x49,
			0x9C, 0x35, 0xCC, 0x36, 0x3C, 0x28, 0x1C, 0xD2,
			0x3E, 0xE7, 0x32, 0x65,
		};
...

	{
		...
		static const uint8_t vector[] = {
			0x46, 0x72, 0x51, 0x24, 0x4F, 0x73, 0x78, 0x95,
			0xFE, 0xE9, 0x49, 0xF1, 0x8E, 0x67, 0x3C, 0x8A,
			0x3E, 0x48, 0x88, 0xB5,
		};
...

	{
		...
		static const uint8_t vector[] = {
			0x77, 0x86, 0xB9, 0x70, 0xAE, 0x65, 0xEE, 0xF6,
			0xD0, 0x21, 0x3C, 0x34, 0xF8, 0x01, 0x6A, 0x8C,
			0xBA, 0x46, 0xEA, 0x6B, 0x08, 0x8E, 0x93, 0x78,
			0xFC, 0xCF, 0xAF, 0x71, 0x7B, 0x7D, 0x2C, 0x10,
			0xBF, 0xCE, 0xE3, 0x30, 0x4B, 0x69, 0x64, 0xD3,
			0xBD, 0x4B, 0x11, 0x21, 0xD1, 0xC0, 0xD3, 0xB1,
			0x4C, 0x93, 0x31, 0xD5, 0x46, 0x6B, 0xD7, 0x5D,
			0x22, 0x0F, 0x0F, 0x17, 0x2B, 0x16, 0xC7, 0xC4,
			0x16, 0xEE, 0xF1, 0x19, 0x44, 0x87, 0x5E, 0x30,
			0x49, 0x67, 0xD4, 0x51, 0x55, 0xCD, 0x63, 0xC5,
