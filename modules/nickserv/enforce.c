...
command_t ns_set_enforce = { "ENFORCE", N_("Enables or disables automatic protection of a nickname."), AC_AUTHENTICATED, 1, ns_cmd_set_enforce, { .path = "nickserv/set_enforce" } };
