...
struct command hs_help = { "HELP", N_(N_("Displays contextual help information.")), AC_NONE, 2, hs_cmd_help, { .path = "help" } };
...
/* HELP <command> [params] */
void hs_cmd_help(struct sourceinfo *si, int parc, char *parv[])
{
	char *command = parv[0];
