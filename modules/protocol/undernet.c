...
/* introduce a client */
static void undernet_introduce_nick(user_t *u)
{
...
/* WALLOPS wrapper */
static void undernet_wallops_sts(const char *text)
{
...
static void undernet_kick(user_t *source, channel_t *c, user_t *u, const char *reason)
{
...
/* numeric wrapper */
static void undernet_numeric_sts(server_t *from, int numeric, user_t *target, const char *fmt, ...)
{
	va_list ap;
	char buf[BUFSIZE];
...
/* PART wrapper */
static void undernet_part_sts(channel_t *c, user_t *u)
{
...
/* mode wrapper */
static void undernet_mode_sts(char *sender, channel_t *target, char *modes)
{
