 ...
 *
 * $Id: p10.c 8223 2007-05-05 12:58:06Z jilles $
 */
...
/* topic wrapper */
static void p10_topic_sts(channel_t *c, service_t *source, const char *setter, time_t ts, time_t prevts, const char *topic)
{
	if (!me.connected || !c)
		return;
