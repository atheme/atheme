 ...
 *
 * $Id: bircd.c 7779 2007-03-03 13:55:42Z pippijn $
 */
...
DECLARE_MODULE_V1("protocol/asuka", TRUE, _modinit, NULL, "$Id: bircd.c 7779 2007-03-03 13:55:42Z pippijn $", "Atheme Development Group <http://www.atheme.org>");
