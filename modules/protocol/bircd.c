 ...
 *
 * $Id: bircd.c 7731 2007-02-25 00:51:36Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/asuka", TRUE, _modinit, NULL, "$Id: bircd.c 7731 2007-02-25 00:51:36Z jilles $", "Atheme Development Group <http://www.atheme.org>");
