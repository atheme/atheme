 ...
 *
 * The People's Democratic Republic of InspIRCd 1.2 support.
 *
 */
...
DECLARE_MODULE_V1("protocol/inspircd12+", true, _modinit, NULL, PACKAGE_STRING, "Atheme Developer Group <http://www.atheme.org/>");
