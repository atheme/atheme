 ...
 *
 * $Id: hybrid.c 8223 2007-05-05 12:58:06Z jilles $
 */
...
DECLARE_MODULE_V1("protocol/hybrid", TRUE, _modinit, NULL, "$Id: hybrid.c 8223 2007-05-05 12:58:06Z jilles $", "Atheme Development Group <http://www.atheme.org>");
...
{
	slog(LG_DEBUG, "hybrid_chan_lowerts(): lowering TS for %s to %lu",
...
static void hybrid_kick(user_t *source, channel_t *c, user_t *u, const char *reason)
{
