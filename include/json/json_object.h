 ...
 */
extern void json_object_object_add(struct json_object *this, char *key, struct json_object *val);
 ...
 */
extern struct json_object *json_object_object_get(struct json_object *this, char *key);
...
#define json_foreach_prepare(obj,key,val) \
char *key; \
 ...
 */
extern int json_object_array_add(struct json_object *this, struct json_object *val);
 ...
 * \param val the json_object to be added
 */
extern int json_object_array_put_idx(struct json_object *this, int idx, struct json_object *val);
 ...
 */
extern struct json_object *json_object_array_get_idx(struct json_object *this, int idx);
