...
#define CMODE_NPC               0x00200000
#define CMODE_SSLONLY           0x00400000
#define CMODE_OPERONLY          0x00800000
#define CMODE_ADMINONLY         0x01000000
#define CMODE_NONOTICE          0x02000000
#define CMODE_IMMUNE            0x04000000

#endif /* !ATHEME_INC_PROTOCOL_CHARYBDIS_H */
